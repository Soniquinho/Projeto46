class Game{
    ...
    {       
            var x, y;
            //escreva o código para criar um obstáculo na posição x aleatória.   fruits = createSprite(random(100, 1000), 0, 100, 100);
            
            
            
            y = 0
            var obstacle = createSprite(random(100, 1000), 0);
